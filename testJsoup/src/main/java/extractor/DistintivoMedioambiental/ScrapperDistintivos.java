...
public class ScrapperDistintivos {
	...
	/**
	 * M�todo que devolver� los distintivos ambientales y su informaci�n asociada
	 * */
	...
	public static DistintivoZero crearDistintivo0(String distintivo, String descripcionDistintivo) {
		...
		Pattern p5 = Pattern.compile("elíctricos híbridos enchufables");
	...
	public static Document getHtmlDocument(String url) {
		...
		try {
			...
			System.out.println("Excepción al obtener el HTML de la p�gina" + ex.getMessage());
		}
		return doc;
	}
