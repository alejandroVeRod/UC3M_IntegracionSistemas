...
/**
 * Clase que para comprobar si el sitio web puede ser crawleado. Lee el fichero
 * robots.txt Basado en
 * http://stackoverflow.com/questions/19332982/parsing-robot-txt-using-java-and-identify-whether-an-url-is-allowed
 * 
 * @author isegura
 *
 */
public class RobotRule {
	...
	public static boolean robotSafe(URL url) {
		...
		if (strCommands.contains(DISALLOW)) // if there are no "disallow" values, then they are not blocking anything.
		{
			...
			for (RobotRule robotRule : robotRules) {
				System.out.println(robotRule.rule);
	...
	public static void main(String args[]) throws MalformedURLException {
		boolean isSafe = robotSafe(new URL("https://labdauc3m.slack.com/messages/@pmf/details/"));
